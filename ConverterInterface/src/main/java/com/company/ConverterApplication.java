...
public class ConverterApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Please enter the Number (1-12) that you would like the If/Else Converter to convert to a Month: " );
        ...
        // enter day number
        System.out.println("Please enter the Number (1-7) for the If/Else Converter to convert to a Day:");
        ...
        System.out.println("Please enter the Number (1-12) you would like the Switch Converter to convert to a Month: ");
        ...
        // enter day number
        System.out.println("Please enter the Number (1-7) for the Switch Converter to convert to a Day:");
